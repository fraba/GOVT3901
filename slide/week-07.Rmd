...
## 3. Target-Group-Centred Campaigning
...
- Early campaign websites were one-way, mass-media style.
- Social media introduced *interactive* campaigning—e.g. forums, Meetups, supporter sharing.
- Campaigns use “structured” or “controlled” interaction to steer engagement (e.g. curated Q&As, pre-loaded content).

### Context Shapes Tech Uptake
- Adoption depends on political, institutional, and media environments.
- E.g. Austria’s late social media uptake due to fear of ridicule or failure.
...
- Voters respond to *"authenticity illusions”*—strategic performances of realness.
- Despite interactive potential, campaigns still largely use social media to *broadcast*, not dialogue.
...
- Campaigns try to shift opinions, identities, emotions—but real persuasion is hard.
- Most people hold stable political views shaped by long-term socialisation.

### Role of Social Media
- Blends mass messaging with interpersonal sharing.
- Messages often received via *weak ties* (friends, acquaintances), increasing credibility.

### Identity and Issue Appeals
- Campaigns aim to make certain identities (e.g. national, economic) or issues feel urgent.
- Politicians try to persuade voters to *prioritise* those identities/issues at the ballot box.
...
- Easier to mobilise partisans than persuade swing voters.
- Campaigns use: partisan messaging, peer-to-peer sharing, “I Voted” buttons, and social pressure.
- Social norms on platforms can influence turnout.

### Demobilising Opponents
- Strategies include:
  - Avoiding controversy to keep opposition passive (e.g. Merkel)
  - Negative ads to lower enthusiasm
  - Disinformation to confuse or discourage
...
### Platforms as Arena
- Social media blend all forms of campaign messaging: official, peer-shared, algorithmic.
- Mobilisation and demobilisation both happen *within and through* platforms.
